...
const Login = () => {
  ...
  return (
    ...
    <form className='w-3/12 p-12 my-36 mx-auto left-0 right-0 absolute bg-black text-white bg-opacity-80'>
      ...
      <input type='text' placeholder='Email Address' className='bg-gray-700 p-2 my-2 w-full'/>
      <input type='password'placeholder='Password' className='bg-gray-700 p-2 my-4 w-full'/>
      <button className='p-4 my-4 w-full bg-red-700 rounded-lg'>{signInForm ? "Sign In":"Sign Up"}</button>
      <div className='flex'>
